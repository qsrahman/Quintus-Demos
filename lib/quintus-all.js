...
var Quintus = function Quintus(opts) {
    ...
    Q._defaults = function(dest, source) {
        ...
        for(var i = 0; i < names.length; i++) {
            ...
            // Get property description from source
            var desc = Object.getOwnPropertyDescriptor(source, names[i]);

            // Use it to create property on this
            Object.defineProperty(dest, names[i], desc);
        }
        return dest;
    };
   ...
   @for Quintus
    ...
    Q.gameLoop = function(callback) {
        ...
        Q.gameLoopCallbackWrapper = function(now) {
            ...
            var dt = now - (Q.lastGameLoopFrame || now);
    ...
    Q.Class.extend("Evented", {
        ...
        /**
         Binds a callback to an event on this object. The event fired only once and
         automatically remove itself when it is fired.
         ...
         @param {Function} [callback] - callback (optional - defaults to name of event on context
        */
        once: function(event, target, callback) {
            var fired = false;
  ...
  */
  Q.GameObject.extend("Sprite",{
    ...
    /**
      ...
      Default properties:

           {
            ...
            x: 0,         // the x location of the center of the sprite
            y: 0,         // the y location of the center of the sprite
            z: 0,         // the stacking order, higher in front, of the sprite (used by the Scenes module)
            ...
            scale: 1,     // the scaling multiplier to grow or shrink the sprite.
            ...
            opacity: 1,
            angle: 0,     // the angle of rotation in degrees of the sprite.
            frame: 0
            type:  Q.SPRITE_DEFAULT | Q.SPRITE_ACTIVE, // a bit-mask used for collision detection
            name: '',
    ...
    */
    ...
    /**
    Get or set the asset associated with this sprite
